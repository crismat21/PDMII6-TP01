...
namespace TP01
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            DisplayAlert("Créditos", "Cristiano Guimarães de Carvalho Fernandes Pinheiro - CB3013111         Patricia Jéssica Santos Fernandes Pinheiro Guimarães de Carvalho - CB3013073", "Ok");
        }
